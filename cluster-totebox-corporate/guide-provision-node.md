...
title: "Provision Node — cluster-totebox-corporate"
...
# Provision Node Guide — cluster-totebox-corporate

This guide covers provisioning a new node for the corporate archive cluster. Full provisioning steps will be documented when the cluster moves from scaffold-coded to active state.
