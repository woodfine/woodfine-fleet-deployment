...
**Taxonomy:** Tier-3 Fleet Node — Gateway Orchestration
**Status:** Active Deployment (gis.woodfinegroup.com)

---

## I. OPERATIONAL MANDATE
This directory serves as the deployment catalog for the GIS workflow gateway, providing the live two-mode location intelligence map at `gis.woodfinegroup.com`. The instance runs on the workspace VM as `gateway-orchestration-gis-1`.
