...
# Provision Node Guide — cluster-totebox-property

This guide covers provisioning a new node for the property archive cluster. Full provisioning steps will be documented when the cluster moves from scaffold-coded to active state.
