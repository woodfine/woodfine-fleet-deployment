...
**Status:** Active Deployment (bim.woodfinegroup.com)

---

## I. OPERATIONAL MANDATE
This directory serves as the deployment catalog for the BIM (Building Information Modeling) workflow gateway at `bim.woodfinegroup.com`. The instance runs as `gateway-orchestration-bim-1`.
