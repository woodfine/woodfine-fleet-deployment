...
# Deployment Guide — cluster-totebox-personnel

Covers initial deployment of the cluster for personnel operations: HR data ingestion, identity ledger management, and SLM-backed communications processing.
